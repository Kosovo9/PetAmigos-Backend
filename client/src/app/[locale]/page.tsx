...
export default function HomePage({ params: { locale } }: { params: { locale: string } }) {
    return (
        <div className="min-h-screen">
            ...
            <section className="relative bg-black/30 backdrop-blur-sm text-white py-32 px-4 border-b border-white/10" aria-label="Hero section">
            ...
            <section className="py-20 px-4" aria-label="Features section">
                <div className="container mx-auto max-w-6xl">
            ...
            {/* CTA Section */}
            <section className="py-20 px-4 bg-gradient-to-r from-purple-900/50 to-pink-900/50 backdrop-blur-md text-white border-y border-white/10" aria-label="Call to action">
