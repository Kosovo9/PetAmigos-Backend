...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        ...
        // Aquí idealmente decodificaríamos el token o haríamos fetch a /api/auth/me
        // Por ahora asumimos que si entra es porque tiene acceso (el backend lo rebotará si no)
    }, []);

    const menuItems = [
        { icon: LayoutDashboard, label: 'Dashboard', href: '/admin' },
        { icon: Users, label: 'Usuarios', href: '/admin/users' },
        { icon: ShieldAlert, label: 'Seguridad Fort Knox', href: '/admin/security' },
