            ...
            <footer className="w-full bg-black/90 backdrop-blur-md border-t border-white/10 py-12">
                <div className="container mx-auto px-4">
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-8 mb-8">
                        ...
                        <img src="https://http2.mlstatic.com/storage/logos-api-admin/a5f047d0-9be0-11ec-aad4-c3381f368aaf-xl@2x.png" alt="Mercado Pago" className="h-10 md:h-12 hover:scale-110 transition-transform brightness-100 bg-yellow-400 px-3 py-1 rounded" />
