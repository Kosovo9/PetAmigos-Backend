...
import {
    Heart, DollarSign, Users, Home, FileText, Image,
    TrendingUp, Plus, Download, CheckCircle, Award, Calendar
} from 'lucide-react';
...
export default function ShelterDashboard() {
    ...
    const tabs = [
        ...
        { id: 'donations', label: 'Donaciones', icon: <DollarSign className="h-4 w-4" /> },
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <h1 className="text-3xl font-bold text-gray-900">Dashboard del Refugio</h1>
                        ...
                        <div className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                <MetricCard
                                    ...
                                    value={`$${metrics.total Received.toLocaleString()}`}
                ...
                />
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                <Card className="lg:col-span-2">
                                    <h3 className="text-lg font-bold mb-4">Donaciones Recientes</h3>
                                    <div className="space-y-3">
                                        {[
                                            { date: '2024-12-15', amount: '$567.50', source: 'Distribución Mensual', status: 'Recibido' },
                                            { date: '2024-11-15', amount: '$524.30', source: 'Distribución Mensual', status: 'Recibido' },
                                            { date: '2024-10-15', amount: '$489.70', source: 'Distribución Mensual', status: 'Recibido' },
                                        ].map((donation, i) => (
                                            <div key={i} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                                <div>
                                                    <p className="font-semibold">{donation.date}</p>
                                                    <p className="text-sm text-gray-600">{donation.source}</p>
                                                </div>
                                                <div className="text-right">
                                                    <p className="text-lg font-bold text-green-600">{donation.amount}</p>
                                                    <span className="text-xs text-green-600">{donation.status}</span>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                ...
                                <div className="space-y-6">
                                    <Card>
                                        ...
                                        <div className="text-center">
                                            <p className="text-3xl font-bold text-green-600">$612.50</p>
                                            <p className="text-sm text-gray-600 mt-2">Estimado para Jan 15, 2025</p>
                                    ...
                                    <Card>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="flex justify-between">
                                                <span className="text-gray-600">Impactos verificados</span>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <Card>
                                    ...
                                    <div className="space-y-4">
                                        {[
                                            { title: 'Campaña de Vacunación', budget: '$1,500', raised: '$890', progress: 59 },
                                            { title: 'Renovación de Instalaciones', budget: '$3,000', raised: '$1,245', progress: 42 },
                                            { title: 'Programa de Esterilización', budget: '$800', raised: '$650', progress: 81 },
                                        ].map((project, i) => (
                                            <div key={i} className="border rounded-lg p-4">
                                                ...
                                                <div className="flex justify-between text-sm">
                                                    <span className="text-gray-600">Recaudado: {project.raised}</span>
                                                    <span className="text-gray-600">Meta: {project.budget}</span>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                    ...
                    {activeTab === 'donations' && (
                        <Card>
                            <div className="flex items-center justify-between mb-6">
                                <h3 className="text-xl font-bold">Historial Completo de Donaciones</h3>
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full">
                                    ...
                                    <tbody>
                                        {[
                                            { date: '2024-12-15', amount: '$567.50', source: 'Plataforma PetMatch', status: 'Recibido' },
                                            { date: '2024-11-15', amount: '$524.30', source: 'Plataforma PetMatch', status: 'Recibido' },
                                            { date: '2024-10-15', amount: '$489.70', source: 'Plataforma PetMatch', status: 'Recibido' },
                                            { date: '2024-09-15', amount: '$512.00', amount: '$512.00', source: 'Plataforma PetMatch', status: 'Recibido' },
                                        ].map((don, i) => (
                                            <tr key={i} className="border-b hover:bg-gray-50">
                                                <td className="py-3">{don.date}</td>
                                                <td className="py-3 font-bold text-green-600">{don.amount}</td>
                                ...
                                <Card key={i}>
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1">
                                            <h4 className="text-lg font-semibold mb-2">Proyecto de Ejemplo {i + 1}</h4>
                                            <p className="text-gray-600 mb-4">
                                                Descripción detallada del proyecto y su impacto esperado en la comunidad de animales.
                                            </p>
                    ...
                    {activeTab === 'impact' && (
                        <div className="space-y-6">
                            <Card>
                                <h3 className="text-xl font-bold mb-4">Galería de Impacto Verificado</h3>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    {[...Array(6)].map((_, i) => (
                                        <div key={i} className="border rounded-lg overflow-hidden">
                                            ...
                                            />
                                            <div className="p-3">
                                                <p className="font-semibold mb-1">Campaña de Vacunación</p>
                                                <p className="text-sm text-gray-600">15 animales vacunados - Dic 2024</p>
