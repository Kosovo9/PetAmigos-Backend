    ...
    return (
        <footer className="w-full bg-black/80 backdrop-blur-md border-t border-white/10 py-12 mt-20">
            <div className="container mx-auto px-4">
                ...
                <div className="text-center text-gray-600 text-xs mt-12 flex flex-col gap-4">
                    <p>© {new Date().getFullYear()} PetMatch World. All rights reserved. Quantum Speed Deployment.</p>
